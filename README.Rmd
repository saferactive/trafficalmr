...
- Create a new repo on GitHub in an appropriate organisation. You can use this template by clicking the "[Use this template](https://github.com/ITSLeeds/traffiCalmr/generate)" button in the top right hand corner of this page.
...
Please note that the `traffiCalmr` project is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.md). By contributing to this project, you agree to abide by its terms.
