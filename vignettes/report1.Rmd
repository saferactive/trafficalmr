...
- Is there available data on the location and extent and date of implementation of 20 mph zones, e.g. digitised versions of the maps shown in @maher_20mph_2018 ([Appendix 1](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/784904/technical-appendix-1-20mph-case-study-descriptions.pdf))?
- In terms of exposure, what count datasets are available in addition to the DfT's [road traffic statistics](https://roadtraffic.dft.gov.uk), which we plan to analyise in the second stage of the project.
- What additional datasets on TROs beyond The Gazette (which is London focussed) are available and to what extent could analysis of TRO data be of use when TRO data systems are rolled-out nationwide?
- To what extent should we focus on analysis of open OSM data on traffic calming interventions vs licensed data from the OS?
