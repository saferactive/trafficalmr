...
Continuing to use the weekday peak hour data, a higher proportion of pedestrian casualties suffer serious injuries or fatalities compared to cycle casualties. For pedestrians, 25.9% of casualties are serious or fatal, but for cyclists this figure is only 19.1%. The mean KSI/bkm walked, at 1430, is slightly higher than the mean KSI/bkm cycled, at 1610, although the figure for pedestrians in particular may be artificially raised by the exclusion of non-commuter journeys.
