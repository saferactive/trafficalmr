...
Road category is included as a random effect in the model. The inclusion of this is vital given that cycling levels vary greatly according to road category, and the number of counts from roads of each category varies from year to year. 

British National Grid eastings and northings are represented in a duchon spline, wihch allows for two dimensional smoothing. This spline has 100 knots, enabling the representation of complex spatial patterns in cycling levels across the UK. 
...
knitr::include_graphics("../../saferactive/figures/GAM-partial-effect-of-year.png")
```
...
knitr::include_graphics("../../saferactive/figures/GAM-partial-effect-of-space.png")
```
