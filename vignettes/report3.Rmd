...
To estimate levels of cycling activity across space, our primary data source is the Propensity to Cycle Tool. 
...
knitr::include_graphics(c("peak-flow-trend-early-years.png"))
```
...
knitr::include_graphics(c("peak-flow-trend-late-years.png"))
```

### Predicting cycle uptake using GAM models

Two GAM models were produced using splines to represent temporal and spatial change in cycling levels.
