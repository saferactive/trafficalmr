...
```{r crashes-speed, fig.cap="Plots of road crashes by road type, speed limit and injury severity – comparison of all versus active-only crashes. Top row: rural, bottom row: urban. KSI in dark red, slight injuries in light red. Recorded crashes in GB 2017-2019.", out.width="80%", fig.show='hold'}
knitr::include_graphics(c(
...
```{r crashes-class-junction, fig.cap="Plots of road crashes by road class, whether or not the crash occured on a junction and injury severity – comparison of all versus active-only crashes. KSI in dark red, slight injuries in light red. Recorded crashes in GB 2017-2019.", out.width="65%", fig.show='hold'}
knitr::include_graphics(c(
