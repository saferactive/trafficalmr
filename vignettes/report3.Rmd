...
- Reduction in peak hour traffic, as shown in reduced travel on working days, the troughs in Figure \@ref(fig:peak).
- People are walking and cycling more, possibly as a result of having to stay in their local area. Data on walking uptake are not reported by in the DfT's COVID-19 transport statistics but the trend from Figure \@ref(fig:covid) suggests the mode shift to cycling in May looks set to continue.
...
```{r covid-transport, fig.cap="Travel by different modes of transport relative to pre-pandemic (early March) levels. Source: DfT", warning=FALSE, out.width="100%", message=FALSE}
